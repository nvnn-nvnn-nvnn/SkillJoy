    ...
    return (
        <div className="page" style={{ maxWidth: 760 }}>
            ...
            <Section title="5. Payments & Escrow">
                Payments for Gigs are held in escrow via Stripe until the buyer releases funds or the auto-release period expires (3 days after delivery). SkillJoy charges a flat platform service fee of $3.50 per transaction. All payments are processed by Stripe and subject to Stripe's terms of service.
            </Section>
